...
class PredictionService
{
    ...
    public function answer(User $user, string $question): array
    {
        ...
        $weather = [
            ...$weather,
            'source_type' => $weather['source_type'] ?? ($pythonResult ? 'Trained Model API' : 'Decision Support Fallback'),
            'source_name' => $weather['source_name'] ?? ($pythonResult ? 'Farming AI API weather model' : 'iClimate local weather rules'),
            'source_credit' => $weather['source_credit'] ?? ($pythonResult
                ? 'Weather output generated by the Farming AI API trained weather model.'
                : 'Fallback weather output generated by iClimate local rules.'),
        ];
        ...
        $yield = [
            ...$yield,
            'source_type' => $yield['source_type'] ?? ($pythonResult ? 'Trained Model API' : 'Decision Support Fallback'),
            'source_name' => $yield['source_name'] ?? ($pythonResult ? 'Farming AI API trained rice yield model' : 'iClimate local yield fallback'),
            'source_credit' => $yield['source_credit'] ?? ($pythonResult
                ? 'Rice yield output generated by the Farming AI API using the trained iClimate Random Forest model.'
                : 'Fallback yield output generated by iClimate rules using saved production and climate inputs.'),
        ];
    ...
    private function fallbackWeather(array $context): array
    {
        ...
        return [
            ...
            'source_type' => 'Decision Support Fallback',
            'source_name' => 'iClimate local weather rules',
            'source_credit' => 'Fallback output generated by iClimate rules using the latest available inputs.',
        ];
    }
    ...
    private function fallbackYield(array $context, array $modelYield = []): array
    {
        ...
        return [
            ...
            'source_type' => 'Decision Support Fallback',
            'source_name' => 'iClimate local yield fallback',
            'source_credit' => 'Fallback output generated by iClimate rules using saved rice production and climate inputs.',
