...
class WeatherPredictionController extends Controller
{
    ...
    private function predictYield(array $modelInput, array $weatherResult, DecisionSupportService $decisionSupport, PythonService $python): array
    {
        ...
        $sourceCredit = $apiError
            ? 'Output generated by the local iClimate trained Random Forest script because the Farming AI API was unavailable.'
            : 'Output generated by the Farming AI API using the trained iClimate Random Forest model.';
