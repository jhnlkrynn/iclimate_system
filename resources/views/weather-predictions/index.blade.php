@php
    ...
    $yieldSource = $mlResult['source'] ?? $mlResult['source_name'] ?? 'Trained Random Forest model';
...
<x-app-layout>
            ...
            <div class="wp-panel mb-4 tone-green">
                ...
                <div class="wp-panel-body">
                    ...
                    @if(isset($mlResult) && $mlResult)
                        <div class="mt-3">
                            <span class="wp-feature-pill">Source: {{ $yieldSource }}</span>
    ...
    <div class="wp-tab-panel" data-weather-panel="rice-yield" @if($activeWeatherTab !== 'rice-yield') hidden @endif>
        ...
        <div class="wp-panel mb-4 {{ $yieldTone }}">
            <div class="wp-panel-header"><h2 class="h5 fw-bold mb-1">Prediction Result</h2><div class="small text-muted">Source: {{ $yieldSource }}{{ ! empty($mlResult['api_confidence']) ? ' | Confidence '.$mlResult['api_confidence'].'%' : '' }}</div></div>
            <div class="wp-panel-body">
