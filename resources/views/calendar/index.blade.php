<x-app-layout>
    ...
    <div class="dark-workspace calendar-page">
        <style>
            .calendar-page .calendar-card, .calendar-page .upcoming-card { overflow: hidden; border-color: rgba(116,198,157,.22); box-shadow: 0 1.2rem 2.6rem rgba(13,31,24,.18); }
            .calendar-page .calendar-toolbar { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 1rem; padding: 1rem 1.25rem; border-bottom: 1px solid rgba(255,255,255,.08); background: linear-gradient(90deg, rgba(82,183,136,.08), rgba(255,255,255,.02)); }
            .calendar-page .calendar-toolbar-month { font-family: 'DM Serif Display', serif; font-size: 1.45rem; min-width: 170px; text-align: center; color: #fff; }
            .calendar-page .calendar-legend { display: flex; flex-wrap: wrap; gap: .6rem; padding: 1rem 1.25rem 0; }
            .calendar-page .calendar-legend-item { display: inline-flex; align-items: center; gap: .4rem; font-size: .75rem; color: rgba(255,255,255,.65); }
            .calendar-page .calendar-legend-dot { width: 10px; height: 10px; border-radius: 999px; box-shadow: 0 0 0 4px rgba(255,255,255,.05); }
            .calendar-page .calendar-grid { display: grid; grid-template-columns: repeat(7, minmax(0, 1fr)); padding: .75rem; gap: .45rem; }
            .calendar-page .calendar-weekday { padding: .6rem .5rem; font-size: .7rem; font-weight: 800; text-transform: uppercase; letter-spacing: .08em; color: rgba(255,255,255,.46); text-align: center; }
            .calendar-page .calendar-day { min-height: 128px; padding: .55rem; border: 1px solid rgba(255,255,255,.07); border-radius: 10px; background: rgba(255,255,255,.025); transition: transform .15s ease, border-color .15s ease, background .15s ease; }
            .calendar-page .calendar-day:hover { transform: translateY(-1px); border-color: rgba(116,198,157,.22); background: rgba(82,183,136,.045); }
            .calendar-page .calendar-day.is-outside { opacity: .36; background: rgba(255,255,255,.015); }
            ...
            .calendar-page .calendar-day-number { display: inline-grid; place-items: center; min-width: 1.75rem; height: 1.75rem; padding: 0 .35rem; border-radius: 999px; font-size: .78rem; color: rgba(255,255,255,.72); margin-bottom: .45rem; font-weight: 800; }
            .calendar-page .calendar-day.is-today .calendar-day-number { color: #0d1f18; background: var(--ic-green-400); }
            .calendar-page .calendar-event { display: grid; gap: .25rem; font-size: .68rem; line-height: 1.25; padding: .42rem .5rem; border-radius: 8px; margin-bottom: .35rem; text-decoration: none; color: rgba(255,255,255,.9) !important; background: rgba(255,255,255,.045); border: 1px solid rgba(255,255,255,.08); border-left: 4px solid var(--event-accent, var(--ic-green-500)); }
            .calendar-page .calendar-event:hover { background: rgba(255,255,255,.075); border-color: rgba(255,255,255,.14); transform: translateX(1px); }
            ...
            .calendar-page .calendar-event-more { font-size: .68rem; color: rgba(255,255,255,.58); padding-left: .25rem; }
            .calendar-page .upcoming-item { display: flex; gap: .75rem; padding: .75rem 0; border-bottom: 1px solid rgba(255,255,255,.08); }
            .calendar-page .upcoming-item:hover { background: rgba(82,183,136,.045); margin-inline: -.55rem; padding-inline: .55rem; border-radius: 10px; }
            ...
            .calendar-page .upcoming-date-day { font-family: 'DM Serif Display', serif; font-size: 1.35rem; line-height: 1; color: #fff; }
            .calendar-page .upcoming-date-month { font-size: .65rem; text-transform: uppercase; letter-spacing: .06em; color: rgba(255,255,255,.5); }
            .calendar-page .upcoming-title { color: #fff; line-height: 1.25; }
            .calendar-page .upcoming-title:hover { color: var(--ic-green-400); }
        ...
        <section class="page-hero">
            <div class="d-flex flex-column flex-xl-row justify-content-between gap-3 align-items-xl-end">
                <div>
                    ...
                    <p class="mb-0 text-white-50">See when advisories start and expire, laid out by day, so you can plan planting and harvesting activities ahead of time.</p>
                </div>
            </div>
        </section>
