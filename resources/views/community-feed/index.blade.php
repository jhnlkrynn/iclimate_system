<x-app-layout>
    <style>
        ...
        .feed-hero { position:relative; overflow:hidden; border-radius:32px; padding:1.75rem 1.85rem; color:#fff; background:linear-gradient(135deg,#0d1f18,#146b78 52%,#0d6a41); box-shadow:0 1rem 2.3rem rgba(13,31,24,.16); }
        .feed-hero::before {
            content:"";
