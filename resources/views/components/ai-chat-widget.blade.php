...
<style>
    ...
    /* ---- Left info panel ---- */
    .ic-ai-left { background: linear-gradient(160deg, var(--ic-hero-from), var(--ic-hero-to) 60%, var(--ic-panel-strong)); color: var(--ic-ink); padding: 1.1rem 1rem; overflow-y: auto; display: flex; flex-direction: column; gap: .9rem; }
